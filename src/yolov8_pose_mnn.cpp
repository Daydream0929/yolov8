...
static const std::vector<cv::Scalar> COLOR_LIST{
    {128, 255, 0}, {255, 128, 50}, {128, 0, 255}, {255, 255, 0}, {255, 102, 255}, {255, 51, 255}, {51, 153, 255}, {255, 153, 153}, {255, 51, 51}, {153, 255, 153}, {51, 255, 51}, {0, 255, 0}, {255, 0, 51}, {153, 0, 153}, {51, 0, 51}, {0, 0, 0}, {0, 102, 255}, {0, 51, 255}, {0, 153, 255}, {0, 153, 153}};
...
void Yolov8PoseMNN::nmSortedboxes(const std::vector<Object> &objects,
...
void Yolov8PoseMNN::drawObject(cv::Mat &img, const std::vector<Object> &objects)
{
...
Yolov8PoseMNN::Yolov8PoseMNN(const MNNPoseConfigs &mnnCfg) : mnnCfg_(mnnCfg)
{
...
Yolov8PoseMNN::~Yolov8PoseMNN()
{
    interpreter_->releaseModel();
    interpreter_->releaseSession(session_);
}

cv::Mat Yolov8PoseMNN::preProcess(cv::Mat &src)
{
...
void Yolov8PoseMNN::postProcess(MNN::Tensor const *output, std::vector<Object> &objects,
...
void Yolov8PoseMNN::detect(cv::Mat &img, std::vector<Object> &objects)
{
    const int &inputW = mnnCfg_.inputSize.width;
    const int &inputH = mnnCfg_.inputSize.height;
